  ...
  return (
    <div className="mx-auto px-8 md:px-[10rem]">
      ...
      <div className="mb-16 md:mb-20 grid gap-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 xl:gap-16">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="#FAF1E4" viewBox="0 0 512 512">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="#FAF1E4" viewBox="0 0 384 512">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="#FAF1E4" viewBox="0 0 448 512">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="#FAF1E4" viewBox="0 0 640 512">
